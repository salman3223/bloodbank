...
display; none; }</style>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark ">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"> <a href="transactions.php" class="nav-link"> <?=_ISSUED?> </a> </li>
    ...
    <div class="container">
      <div class="jumbotron">
        <p style='text-align:center;'><b><?=_CONTENT8?> : </b>1 (<?=_AMOUNT?>) = 500 ml</p>
        <?php
          include 'dbh.php';
            $person = $_SESSION['id'];
            $nsql = "SELECT amount,bloodgrp,donate_dt FROM donate where id = '$person'";
