  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark ">
        <ul class="navbar-nav">
          ...
          <li class='nav-item'> <a href='donor.php' class='nav-link'>Donors</a> </li>
    ...
    <div class="container">
      <div class="jumbotron">
        <p style='text-align:center;'><b>Issued : </b>1 (Amount) = 500 ml</p>
        <?php
          include 'dbh.php';

            $nsql = "SELECT name,phone,email,amount,bloodgrp,issue_dt FROM issue
                    INNER JOIN blooduser on issue.id = blooduser.id";
