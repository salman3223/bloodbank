...
display; none; }</style>
    ...
    <div class="container">
      <div class="jumbotron">
        <h3><?=_CONTENT6?></h3>
        <p> <i> <?=_CONTENT7?></i></p> <br>

        <form class="" action="donate-backend.php" method="POST">
          <div class="row">
            <div class="col">
          ...
          <div class="form-group col-md-8" >
            <div class="row">
              ...
              <div class="signupbutton">
                <br><br>
                <button type="submit" class="btn btn-success btn-lg" name="sub" value="submit"><?=_DONATE?></button>
